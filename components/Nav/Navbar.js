    ...
    return loading ? null : (
        <nav className={`w-full h-16 border-b border-gray-200 px-10`}>
            <ul className={`flex flex-row justify-between items-center h-full`}>
                <div
                    className="flex flex-row justify-around lg:justify-start gap-5 items-center h-full lg:w-1/3 w-1/2 text-gray-500 font-semibold">
					<span
                    ...
                    {!session ? (
                        ...
                        <>
                            ...
                            >
                                ...
                                <span
                                    className={`inline-block capitalize mr-2 font-semibold leading-loose tracking-wide`}>{user?.firstName.toLowerCase()}</span>
                                {toggleDropdown ? (
